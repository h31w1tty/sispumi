...
<body>
	<div class="wrapper">
        ...
        <div class="main p-3">
            <br>
            <br>
                <h1 style="color: #760E9A;"><strong>Serviços | Serviço - 01 </strong></h1>
                <hr>
                ...
                <div class="row">
                    <div class="col-sm-8">
                        <div class="input-group mb-3">
                            ...
                            <input type="text" class="form-control" placeholder="Serviço - 01" aria-label="Username" aria-describedby="basic-addon1">
                        </div>
                        <div class="mb-3">
                    ...
                    <div class="col-sm-3">
                        <img src="servico.jpg" class="img-fluid" style="border-radius: 10px;">
                        <br>
                        <br>
