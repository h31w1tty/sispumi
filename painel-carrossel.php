            ...
            <div class="text-center">
                <div class="row">
                    ...
                    <div class="col-sm-8">
                        ...
                        <div class="mb-3">
                            <button type="button" class="btn btn-danger" name="btn" onclick="excluir()" value="deletar" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Apaga a postagem atual.">Deletar</button>
